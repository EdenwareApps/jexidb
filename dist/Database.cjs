  ...
  return _createClass(Database, [{
          ...
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 38:
              ...
              if (!String(_context2.t0).includes('empty file')) {
                console.error('Error loading database:', _context2.t0);
              }
            case 43:
              _context2.prev = 43;
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 26:
              ...
              console.error('Error flushing:', _context7.t0);
            case 29:
              _context7.prev = 29;
              _context7.next = 32;
              return fd.close();
    ...
    value: function walk(map) {
      ...
      return _wrapAsyncGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        var currentPartition, ranges, partitionedRanges, line, m, _i, _partitionedRanges, _ranges, lines, _loop, _line;
        return _regeneratorRuntime().wrap(function _callee8$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 22:
              ...
              _context9.t1 = _regeneratorRuntime().keys(lines);
            case 25:
              if ((_context9.t2 = _context9.t1()).done) {
                _context9.next = 32;
                break;
              }
              _line = _context9.t2.value;
              return _context9.delegateYield(_loop(), "t3", 28);
            case 28:
              if (!_context9.t3) {
                _context9.next = 30;
                break;
              }
              return _context9.abrupt("continue", 25);
            case 30:
              _context9.next = 25;
              break;
            case 32:
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            ...
            case 28:
              ...
              return _context12.delegateYield(_loop2(), "t1", 30);
            case 30:
              _context12.next = 28;
              break;
            case 32:
            ...
            case 34:
              _context12.prev = 34;
              _context12.t2 = _context12["catch"](25);
            ...
            case 47:
              ...
              this.shouldSave = true;
              return _context12.abrupt("return", entries);
            case 50:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee11$(_context13) {
          while (1) switch (_context13.prev = _context13.next) {
            ...
            case 20:
              ...
              this.shouldSave = true;
              return _context13.abrupt("return", ranges.length);
            case 28:
            case "end":
